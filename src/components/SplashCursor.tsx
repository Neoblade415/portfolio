  ...
  useEffect(() => {
    ...
    const displayShaderSource = `
      ...
      void main () {
          ...
          // Apply thresholding for a hard "liquid/gooey" edge instead of soft smoke
          float alpha = smoothstep(0.4, 0.45, a); 
          vec3 finalColor = vec3(1.0); // Force pure white for maximum difference blend
