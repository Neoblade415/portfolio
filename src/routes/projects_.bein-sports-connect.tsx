  ...
  return (
    <motion.div ref={scrollRef} className="w-full h-full crt-content-scroll" style={{ background: "#f2f0ec" }}>
      <div className="w-full text-[#222]">
        ...
        {/* Hero */}
        <div className="w-full bg-[#201041] aspect-[21/9] flex items-end p-8 md:p-16 relative overflow-hidden">
        ...
        <Link to="/projects/ing-bank" state={{ transitionText: "LOADING" }} className="block w-full bg-[#ff6200] text-white aspect-[21/9] flex items-end p-8 md:p-16 relative overflow-hidden group">
