  ...
  return (
    <motion.div ref={scrollRef} onScroll={handleScroll} className="w-full h-full crt-content-scroll" style={{ background: "#f2f0ec" }}>
      <div className="w-full text-[#222]">
        ...
        {/* Hero */}
        <div className="w-full bg-[#111] h-screen min-h-[600px] flex items-end p-8 md:p-16 relative overflow-hidden">
        ...
        <Link to="/projects/zynga-solitaire" state={{ transitionText: "LOADING" }} className="block w-full bg-[#1e4a3b] text-white h-screen min-h-[600px] flex items-end p-8 md:p-16 relative overflow-hidden group">
